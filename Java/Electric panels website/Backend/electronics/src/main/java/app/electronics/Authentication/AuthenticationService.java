...
import app.electronics.EmailConfiguration.EmailService;
import app.electronics.Exceptions.EmailAlreadyUsedException;
import app.electronics.JwtConfiguration.JwtService;
import app.electronics.User.Role;
...
public class AuthenticationService {
    ...
    public String authenticate(LoginDTO loginUserDto) {

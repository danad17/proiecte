package app.electronics.JwtConfiguration;
    ...
    protected void doFilterInternal(
        ...
        try {
            ...
            if (userEmail != null && authentication == null) {
                ...
                // ← eliminat else cu sendError — lăsăm Spring Security să decidă
            }
            ...
            filterChain.doFilter(request, response); // alte erori — continuă
        }
    }
}